...
f1 = open("D:\IFS\python_train\English_train.txt", "r")
...
f1 = open("D:\IFS\python_train\Test_POS_Tagging.txt", "r")
f2 = open("D:\IFS\python_train\Output\ new1.txt", "w")
f3 = open("D:\IFS\python_train\Output\ new2.txt", "w")
tag_given_word = {}
for line in f1:
    # f2.write(line)
        ...
        for tag in tag_dict.keys():
            ...
            if word_tag in word_tag_dict.keys():
                ...
                if not word_tag in tag_given_word.keys():
                    ...
                    f3.write("P(" + tag.upper() + "|" + word_token + ")" + ":" + str(tag_given_word[word_tag]) + "\n")
        f2.write(word_token + "_" + random.choice(
            predicted_tags_with_max_probability).upper() + " ")  # randomly choose from list of max & equal probable tags
